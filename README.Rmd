...
The polyreg package implemets direct polynomial regression to jointly model multiple competing events. It estimates multiplicative effects on cumulative probabilities or risks possibly under right-censoring. The package also supports semiparametric models for common effects over time, direct binomial regression for survival outcome, and Richardson model for binomial outcome, which use a log odds product. 
